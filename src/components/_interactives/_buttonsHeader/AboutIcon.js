...
// == Composant
const AboutIcon = ({ onClickToShowAbout }) => (
  <div className="aboutIcon aboutIcon--bottomLeftDesktop" onClick={onClickToShowAbout}>
    <span className="aboutIcon__questionMark">?</span>
    <svg className="aboutIcon__svg" width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g className="aboutIcon__corners">
...
AboutIcon.propTypes = {
  onClickToShowAbout: PropTypes.func.isRequired,
};
